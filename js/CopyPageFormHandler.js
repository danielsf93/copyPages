/**
 * @file js/CopyPageFormHandler.js
 *
 ...
 * @class CopyPageFormHandler
 *
 * @brief Copy pages form handler.
 */
(function($) {

	/** @type {Object} */
	$.pkp.controllers.form.copyPages =
			$.pkp.controllers.form.copyPages || { };
	 ...
	 * @type {?string}
	 */
	$.pkp.controllers.form.copyPages.CopyPageFormHandler.prototype.
			previewUrl_ = null;
